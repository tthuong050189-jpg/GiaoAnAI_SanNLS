...
<div style='text-align: center; background: linear-gradient(135deg, #004e92 0%, #000428 100%); padding: 20px; border-radius: 10px; color: white; margin-bottom: 20px;'>
    ...
    <p style='margin-top:10px;'>Tác giả: Cô Trương Thị Hương - TH Vĩnh Lộc</p>
</div>
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trương Thị Hương - Trường Tiểu học Vĩnh Lộc - ĐT: 097 3563 516</div>", unsafe_allow_html=True)
